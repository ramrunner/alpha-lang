...
expr	:assignexpr  
	...
	{	
		...
		{	// Edw 8a xriastoun jumps
			...
			Expr* retExpr;
			Quad *tmpQuad;
			tmpSym = createSymbol(TMP, (char *)newTmp(), yylineno);
...
assignexpr	: lvalue opASSIGN expr
			{  
                ...
                retExpr = createExpr(createSymbol(TMP, (char *)newTmp(), yylineno), ASSIGN_E, tmpCV, NULL);
